...
def generate_random_location_within_map_domain(seed, unique_id):
    """
...
def get_flood_depth(corresponding_map, location, band):
    ...
    flood_depth = band[row -1, col -1]
    return flood_depth ##This used to be just depth, but i saw this was not used anywhere
